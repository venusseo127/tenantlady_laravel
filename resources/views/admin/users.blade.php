                ...
                <table class="min-w-full divide-y divide-slate-200">
                    <thead class="bg-slate-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Listings</th>
                    ...
                    <tbody class="divide-y divide-slate-200">
                        @foreach($users as $u)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap"><span class="px-2 py-1 text-xs rounded-full bg-slate-100">{{ ucfirst($u->plan) }}</span></td>
                                <td class="px-6 py-4 whitespace-nowrap text-slate-600">{{ $u->listings_count }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-slate-600">{{ $u->tenants_count }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-slate-600">{{ $u->created_at->format('M d, Y') }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
